export const questionsDay1 = [
  ...
  },
  {
    ...
    answers: [
      ...
      "Changeable, but only in urban areas",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "How women and men, boys and girls should  look and behave in society ",
    ],
  },
  {
    trueAnswer: 0,
    ...
    answers: [
      ...
      "Specific rights which belong only to women",
    ],
  },
  {
    trueAnswer: 1,
    ...
    answers: [
      ...
      "Already achieved in our society ",
    ],
  },
  {
    trueAnswer: 2,
  ...
  },
  {
    ...
    answers: [
      ...
      "Personal decision of every woman",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "Women and men, girls and boys have equal conditions, treatment and opportunities for realizing their full potential and for contributing to (and benefitting from) economic, social, cultural and political development.",
    ],
  },
];
...
export const questionsDay2 = [
  {
    ...
    answers: [
      ...
      "Useful preconceived ideas whereby females and males are arbitrarily assigned characteristics and roles",
      "Harmful preconceived ideas whereby females and males are arbitrarily assigned characteristics and roles determined and limited by their gender",
    ],
  },
  {
    trueAnswer: 3,
    ...
    answers: [
      ...
      "they make it impossible to establish a culture of equality in the community",
      "because the state's obligation is in accordance with the international obligations that the state has signed",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "Men want to be parent just as much as women",
  ...
  },
  {
    ...
    answers: [
      ...
      "they are action without thinking",
...
export const questionsDay3 = [
  {
    ...
    answers: [
      ...
      "Equality in low (equal tretmant) , equal oportunities and gender mainstreaming",
    ],
  },
  {
    trueAnswer: 1,
    ...
    answers: [
      ...
      "With adoption of CEDAW Convention in 1975",
    ],
  },
  {
    trueAnswer: 1,
  ...
  },
  {
    ...
    answers: [
      ...
      "State should consider wether  new low or new strategie  contribute to eqality of women and men, boys and girls in our sociaty",
    ],
  },
  {
    trueAnswer: 1,
    ...
    answers: [
      ...
      "Take women’s needs first and adjust all policies towards women’s issues",
    ],
  },
  {
    trueAnswer: 0,
    ...
    answers: [
      ...
      "Obligation acording to our Statistic Low ",
    ],
  },
  {
    trueAnswer: 1,
    ...
    answers: [
      ...
      "Adding the one mesure in strategy or low related to women",
      "Looking at women and men as a homogenous group ",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "Calculate the number of boys and girls in schools, the number of teachers by sex, analyze school programs (do they promote stereotypes or encourage boys and girls to be what they want), are there any special programs to promote equality, are there any special support measures for children from poor families , rural areas, children with developmental disabilities; how disciplinary measures are prescribed for boys and girls, etc.",
    ],
  },
];
...
export const questionsDay4 = [
  {
    ...
    answers: [
      ...
      "Both - as general legal protection within the standards of international human rights law and as a special protection of women",
    ],
  },
  {
    trueAnswer: 1,
  ...
  },
  {
    ...
    answers: [
      ...
      "Understand motherhood as a social function and affirm the mutual responsibility of women and men in the upbringing of children, with providing the interests of the child as primary.",
      "Change environments in which women are in subjugated position and create equal conditions and opportunities for all, that is, create equal opportunities, equal access and equal results.primary.",
    ],
  },
  {
    trueAnswer: 1,
  ...
  },
  {
    ...
    answers: [
      ...
      "To regulate unpaid parental leave",
      "To increase the representation of women in elected government bodies",
      "All this goals",
    ],
  },
  {
    ...
    answers: [
      ...
      "Maybe is not good solution, but in our country women take care about children and it is realistic",
    ],
  },
];
...
export const questionsDay5 = [
  {
    ...
    answers: [
      ...
      "This therminology is not aplicable on statistc",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "Data that captures specific gender issues – even when these issues do not necessarily mention gender",
      "Statistic about boys",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "Proportion of households using clean fuels for cooking and heating",
      "Total value of inward and outward illicit financial flows, in USD",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "Advocate for gender equality and women’s and girls’ empowerment in an effective and truthful way",
      "Conduct analysis and academic research on the differentiated characteristics of the lives of women and men.",
      "All of this answers ",
    ],
  },
  {
    ...
    answers: [
      ...
      "Parcialy true – only a few aspects of development are related to gender equality",
    ],
  },
  {
    trueAnswer: 2,
  ...
  },
  {
    ...
    answers: [
      ...
      "Limited coordination among various data producers within a National Statistical System",
      "Nobody is asking for that information",
      "Limited technical capacity on the part of data producers to generate data in some methodologically challenging areas",
      "Limited awareness on the part of users about the existance of gender data",
      "Those data are irrelevant and not important",
      "Nobody knows what thet means",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "There is no such thing as gender statistic, all data are relevant for whole sociaty",
      "Getting gender statistics is sometimes so expensive that it's not worth the effort",
      "National strategies and statistics laws should prioritzie the collection and use of gender data in every country",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "Implementanton  of National Strategy of Gender Equality end Gender Equality Low",
      "All of this metioned above",
    ],
  },
];
...
export const questionsDay6 = [
  {
    ...
    answers: [
      ...
      "to the legal obligation to collect gender-segregated data",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "Yes, because every gender analysis should start with gender data.",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "respond on international obligation of our country",
      "seeking and articulating the viewpoints of women and men and making their contribution a critical part of developing policies",
      "promoting women’s participation and engagement in community, political and economic life",
      "create more effective and more adequate lows and policies for our citizens",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "Local institutions and local policies",
      "Institutions which provide services to citizens such as school, police, health services",
      "All above",
    ],
  },
  {
    ...
    answers: [
      ...
      "Women’s participation in the labor force remains concentrated in sectors defined as the service sphere with 71.4% of women employed in this sector compared to 52% of the men. Women and men are fairly evenly represented in agriculture, forestry, and fishery, where 17.1% of women are employed compared to 18.9% for men. The percentage of women employed in agriculture declined by 34% from 2006 to 2016). However, as women move out of agriculture, they are remaining in lower-paying service sector positions rather than accessing higher-paying industrial jobs. This happens because of traditional education (women graduated from schools for beauticians, hairdressers, and caregivers) but also because of gender roles in which it is very important for a woman to strike a balance between private and business life, and because of this, it is harder for her to progress in her career.",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "More women enter health centers at the local level than men; women bring their children to the pediatrician, women go to the doctor more often in their old age, and the gynecological service is also located in the local health center",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "in all stages of policy circle  - before policy creation, while it is being implemented and at the end of the cycle to see the impact on women and men",
    ],
  },
  {
    trueAnswer: 2,
    ...
    answers: [
      ...
      "State should  provide adequate gender data and use them to consider wether  new low or new strategie  contribute to eqality of women and men, boys and girls in our sociaty end give them equal oportuinites in our sociaty",
    ],
  },
  {
    trueAnswer: 2,
